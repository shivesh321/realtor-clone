    ...
    <section>
      ...
      >
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img
            src="https://media.istockphoto.com/id/821895542/photo/house-key-in-hand.webp?b=1&s=170667a&w=0&k=20&c=tRXqlrgDSerrLvoaXoqQv_gjTWOHSngQQIh5v1JwWKY="
            alt="key"
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form>
            ...
            <div className="relative">
              ...
              {showPassword ? (
                <AiFillEyeInvisible
                  className="absolute right-3 top-3 text-xl first-letter
                cursor-pointer"
