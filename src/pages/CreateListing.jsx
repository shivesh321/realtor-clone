...
export default function CreateListing() {
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form>
        <p className="text-large mt-6 font-semibold">Sell/Rent</p>
        <div className="flex">
          <button
            type="button"
            id="button"
            ...
            shadow-md rounded hover:shadow-lg transition duration-150
            ease-in-out w-full ${
              type === "rent"
                ? "bg-white text-black "
        ...
        <p className="text-large mt-6 font-semibold">Parking spot</p>
        <div className="flex">
          <button
            type="button"
            id="parking"
        ...
        <p className="text-large mt-6 font-semibold">Furnished</p>
        <div className="flex">
          <button
            type="button"
            id="furnished"
        ...
        <textarea
          ...
          "
        />
        <p className="text-large mt-6 font-semibold">Offer</p>
        <div className="flex ">
          <button
            type="button"
            id="offer"
        ...
        <button
          type="submit"
          className="mt-6 mb-6 w-full px-7 py-3
         bg-blue-600 text-white font-medium text-sm uppercase rounded-sm
